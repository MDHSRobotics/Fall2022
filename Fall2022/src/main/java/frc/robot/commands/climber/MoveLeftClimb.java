...
public class MoveLeftClimb extends CommandBase {
    ...
    public MoveLeftClimb(LeftClimber climber) {
        Logger.setup("Constructing Command: Move Left Climb...");
    ...
    public void initialize() {
        Logger.action("Initializing Command: Move Left Climb...");
    }
    ...
    public void end(boolean interrupted) {
        if (interrupted) {
            Logger.ending("Interrupting Command: Move Left Climb...");
        } else {
            Logger.ending("Ending Command: Move Left Climb...");
        }
